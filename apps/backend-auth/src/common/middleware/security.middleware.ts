...
export interface RateLimitConfig {
   ...
   * Default: IP address
   */
  keyGenerator?: (req: { ip?: string; headers?: Record<string, string | string[]> }) => string;
}
 ...
 *
 * @param req - Express request with context and headers
 * @returns Rate limit key
 */
export function tenantRateLimitKeyGenerator(req: {
