...
export class MetricsService {
  ...
  constructor() {
    ...
    this.httpRequestsInFlight = new Gauge({
      name: 'subscription_service_http_requests_in_flight',
    ...
    this.dbOperationsTotal = new Counter({
      name: 'subscription_service_db_operations_total',
    ...
    this.dbConnectionsActive = new Gauge({
      name: 'subscription_service_db_connections_active',
    ...
    this.eventLoopLag = new Gauge({
      name: 'subscription_service_event_loop_lag_seconds',
