 ...
 *
 * @param _req - Express request (unused, required by compression middleware interface)
 ...
 */
export function createCompressionMiddleware(config: CompressionConfig = {}): RequestHandler {
  const {
 ...
 */
export const compressionMiddleware: RequestHandler = createCompressionMiddleware();
