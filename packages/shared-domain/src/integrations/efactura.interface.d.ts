...
export declare enum EFacturaStatus {
    DRAFT = "DRAFT",
    SUBMITTED = "SUBMITTED",
    ACCEPTED = "ACCEPTED",
    REJECTED = "REJECTED",
...
export declare enum EFacturaDocumentType {
    INVOICE = "INVOICE",
...
export interface EFacturaProviderAdapter {
    ...
    cancel(submissionId: string, reason: string): Promise<IntegrationResult<{
        canceled: boolean;
    }>>;
    downloadXml(downloadId: string): Promise<IntegrationResult<{
        xml: string;
    }>>;
}
